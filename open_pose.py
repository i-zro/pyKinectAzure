...
# 각 파일 path
protoFile = "./caffe/pose_deploy.prototxt"
weightsFile = "./caffe/pose_iter_584000.caffemodel"
...
output_keypoints(proto_file=protoFile, weights_file=weightsFile,
